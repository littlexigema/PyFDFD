...
classes = "multi_shapes"#'AU'#'multi_shapes'
name_ = '2/'#'1/'#'ground_truth.npy'#'1/gt.npy'
...
def render(freq, H, W, N_cell, E_inc, Phi_mat, R_mat, input,input_J,  network_fn, network_fn_J, network_query_fn,global_step):
    ...
    #re['R_mat_J'] = R_mat @ J
    # A = A.to_dense()
    FWD.field.set_scatter_E_Born_Appro(A)
...
def config_parser():
    ...
    parser.add_argument("--expname", type=str,default=f"FDFD_{classes}_nonoise_PE_n_features_512_tanh",
